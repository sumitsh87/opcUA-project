...
public class ParentFragment extends Fragment {
	...
	@Override
	public int getCount() {
		int size=BrowseMenuFragment.ListPageT.get(listIndex).getItemList().getWindowOrDialogOrPage().size();
	...
	{
		if(isPageList==1)
			return((GroupT)BrowseMenuFragment.ListPageT.get(listIndex).getItemList().getWindowOrDialogOrPage().get(position).getValue()).getLabel() ;
		else
			return BrowseMenuFragment.ListGroupT.get(listIndex).getLabel() ;
	}
